...
#define PIXELS 100  // Number of pixels in the string. I am using 4 meters of 96LED/M
...
#define RES 500000   // Width of the low gap between bits to cause a frame to latch #define RES 500000
